	...
	// draw function
 	draw: function(renderer) {
 		...
 		if(typeof(this.settings.text) === "string") {
			...
			context.font      = 'bold 20pt Nevis';
			context.textAlign = 'center';
			context.fillStyle = '#492811';
			context.fillText(this.settings.text, (me.game.viewport.width) / 2, this.pos.y + this.height / 2 + 5 + this.textOffset.y);
 		}
 	}
});
...
game.Menu = me.Container.extend({
	...
	addMenuItem : function (settings) {
		...
		this.addChild.defer(this, menuItem);
